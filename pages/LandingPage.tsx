...
const LandingPage: React.FC = () => {
  const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; children: React.ReactNode }> = ({ icon, title, children }) => (
    <div className="bg-green-50 p-12 rounded-full text-center transform hover:bg-green-100 transition-colors border border-green-100">
  ...
  return (
    <div className="bg-white">
      ...
      <main>
        {/* Hero Section */}
        <section className="py-32 md:py-48 bg-white flex flex-col items-center justify-center text-center">
          <div className="container mx-auto px-8 max-w-5xl">
            <h1 className="text-5xl md:text-7xl font-bold text-green-900 leading-tight mb-8">
              Your Neighborhood, <br />
              <span className="text-green-700">At Your Fingertips.</span>
            </h1>
            ...
            <Link
              to="/login"
              className="inline-block bg-green-800 text-white px-12 py-4 rounded-full text-xl font-medium hover:bg-green-900 transition-colors"
            >
              Get Started
            </Link>
          </div>
        ...
        <section id="how-it-works" className="py-32 bg-gray-50">
          <div className="container mx-auto px-8 max-w-7xl text-center">
            <h2 className="text-4xl font-bold text-green-900 mb-20">How It Works</h2>
            <div className="grid md:grid-cols-3 gap-16">
              <div className="flex flex-col items-center space-y-8">
                ...
                <p className="text-gray-600 text-lg leading-relaxed max-w-sm">
                  Use our map to find services near you, from salons to repair shops.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-8">
                <div className="bg-green-800 p-8 rounded-full">
                ...
                <p className="text-gray-600 text-lg leading-relaxed max-w-sm">
                  Check shop status, services, prices, and available staff instantly.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-8">
                <div className="bg-green-800 p-8 rounded-full">
                ...
                <p className="text-gray-600 text-lg leading-relaxed max-w-sm">
                  Directly connect with the shop to avail services. Simple and fast.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="benefits" className="py-32 bg-white">
          <div className="container mx-auto px-8 max-w-7xl text-center">
            <h2 className="text-4xl font-bold text-green-900 mb-20">Why Choose YahiPe?</h2>
